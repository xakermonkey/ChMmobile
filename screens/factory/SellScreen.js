            ...
            <ScrollView style={{ marginTop: '4%' }}>
                ...
                <View style={{ padding: '4%' }}>
                    ...
                    <View style={{ marginTop: '4%', flexDirection: 'row', justifyContent: 'space-between' }}>
                        <TextInput style={{ backgroundColor: '#f2f2f3', padding: '4%', borderRadius: 20, width: '49%' }}>21.01.2023</TextInput>
                        <TextInput style={{ backgroundColor: '#f2f2f3', padding: '4%', borderRadius: 20, width: '49%' }}>17:00</TextInput>
                    </View>
                </View>
                ...
                <View style={{ padding: '4%' }}>
                    ...
                    <View style={{ backgroundColor: '#f2f2f3', padding: '4%', borderRadius: 20, marginTop: '4%' }}>
                        <TextInput style={[styles.text400_16, colorScheme.themeTextStyle2]}>160</TextInput>
                    </View>
                </View>
                ...
                <View style={{ padding: '4%' }}>
                    ...
                    <View style={{ backgroundColor: '#f2f2f3', padding: '4%', borderRadius: 20, marginTop: '4%' }}>
                        <TextInput style={[styles.text400_16, colorScheme.themeTextStyle2]}>50</TextInput>
                    </View>
                </View>
