    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
                ...
                <SafeAreaView style={{}}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: '3%' }}>
                        ...
                        <TouchableOpacity activeOpacity={0.9} style={{ backgroundColor: '#5e6f64', padding: '2%', borderRadius: 20, justifyContent: 'center', alignItems: 'center' }}
                            onPress={async () => { navigation.navigate('sell_screen'); }}>
            ...
            <ScrollView style={{ marginTop: '4%' }}>
                <Text style={{ fontFamily: 'Inter_700Bold', fontSize: 20, textAlign: 'center' }}>Сделки</Text>
                ...
                <View style={{ padding: '4%' }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        <View style={{ width: '80%' }}>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                <View>
                                    <Text style={{ fontFamily: 'Inter_400Regular', color: '#0000004F', fontSize: 12 }}>масса, кг</Text>
                                    <Text style={{ fontFamily: 'Inter_500Medium', color: 'black', fontSize: 16 }}>80</Text>
                                </View>
                                <View style={{ width:100 }}>
                                    <Text style={{ fontFamily: 'Inter_400Regular', color: '#0000004F', fontSize: 12 }}>цена за кг, руб</Text>
                                    <Text style={{ fontFamily: 'Inter_500Medium', color: 'black', fontSize: 16 }}>20</Text>
                                </View>
                            </View>
                            <View style={{ height: 1, backgroundColor: '#f2f2f3' }}></View>

                            <Text style={{ fontFamily: 'Inter_400Regular', color: '#0000004F', fontSize: 12 }}>стоимость, руб</Text>
                            <Text style={{ fontFamily: 'Inter_500Medium', color: 'black', fontSize: 16 }}>1600</Text>
                        </View>
                    </View>
                </View>
