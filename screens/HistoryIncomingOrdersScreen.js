    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <ScrollView style={{ marginTop: '4%' }}>
                <Text style={{ fontFamily: 'Inter_700Bold', fontSize: 20, textAlign: 'center' }}>История заказов</Text>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop:'4%' }}>
                    ...
                    <View style={{ width: '100%' }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            <View>
                                <Text style={{ fontFamily: 'Inter_400Regular', color: '#0000004F', fontSize: 12 }}>номер заказа</Text>
                                <Text style={{ fontFamily: 'Inter_500Medium', color: 'black', fontSize: 16 }}>0000632</Text>
                            </View>
                            <View>
                                <Text style={{ fontFamily: 'Inter_400Regular', color: '#0000004F', fontSize: 12 }}>статус</Text>
                                <Text style={{ fontFamily: 'Inter_500Medium', color: '#632A2A', fontSize: 16 }}>Отклонен</Text>
                            </View>
                        </View>
                        <View style={{ height: 1, backgroundColor: '#f2f2f3' }}></View>
